...
/* 
	...
	Kanji Mode [3]
*/
class CharacterCapacitiesTable {
	constructor() {
		this.data = [
			{
				"L": [],
	...
	getCapacity(version, ecLevel, mode) {
		return this.data?.[version]?.[ecLevel]?.[modesTable.getModeIndex(mode)] || null
	}
	getVersion(bytes, ecLevel, mode) {
		return this.data.findIndex(data => data[ecLevel][modesTable.getModeIndex(mode)] > bytes)
	}
}

export default new CharacterCapacitiesTable()